"""One-time manual check: runs one real MTSamples case through PICO-candidate generation using the real MedGemma model via Ollama."""
...
if __name__ == "__main__":
    ...
    case = load_case(clean_df, case_id=0)
